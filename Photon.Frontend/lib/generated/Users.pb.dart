...
class UpdateFCMTokenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateFCMTokenRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'Photon.Backend.Protos'), createEmptyInstance: create)
...
class GetUserRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetUserRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'Photon.Backend.Protos'), createEmptyInstance: create)
...
class UpdateUsernameRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateUsernameRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'Photon.Backend.Protos'), createEmptyInstance: create)
